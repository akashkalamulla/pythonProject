...
def tower_of_hanoi():
    new_page_path = r"C:/Users/AKASH/Documents/NIbm Digree/PDSA module/pythonProject/Games/Game1/game.py"
    try:
...
def sixteen_queens_puzzle():
    new_page_path = r"C:\Users\AKASH\Documents\NIbm Digree\PDSA module\pythonProject\Games\Game2\game.py"
    try:
        subprocess.run(['python', new_page_path], check=True)
    except subprocess.CalledProcessError as e:
        print(f"Error occurred while opening new page: {e}")
...
def minimum_cost():
    new_page_path = r"C:\Users\AKASH\Documents\NIbm Digree\PDSA module\pythonProject\Games\Game3\neupdate.py"
    try:
        subprocess.run(['python', new_page_path], check=True)
    except subprocess.CalledProcessError as e:
        print(f"Error occurred while opening new page: {e}")
...
def identify_shortest_path():
    new_page_path = r"C:\Users\AKASH\Documents\NIbm Digree\PDSA module\pythonProject\Games\Game4\pdsa\gui-game\build\gui.py"
    try:
        subprocess.run(['python', new_page_path], check=True)
    except subprocess.CalledProcessError as e:
        print(f"Error occurred while opening new page: {e}")
...
def predict_value_index():
    new_page_path = r"C:\Users\AKASH\Documents\NIbm Digree\PDSA module\pythonProject\Games\Game5\game.py"
    try:
        subprocess.run(['python', new_page_path], check=True)
    except subprocess.CalledProcessError as e:
        print(f"Error occurred while opening new page: {e}")
